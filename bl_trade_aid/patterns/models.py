...
class ScanData(TimeStampedModel):
    ...
    benchmark = models.CharField(_('benchmark'), max_length=100,
                                 help_text=_('benchmark'))

    projection = models.CharField(_('projection'), max_length=100,
                                  help_text=_('projection'))

    legsStr = models.CharField(_('legsStr'), max_length=100,
                               help_text=_('legsStr'))
...
class ContractDetails(TimeStampedModel):
    ...
    contract = models.ForeignKey('Contract',  verbose_name=_('Contract'), related_name='contract_details',
                                 on_delete=models.PROTECT)

    marketName = models.CharField(_('MarketName'), max_length=12,
                                  help_text=_('MarketName'))

    minTick = models.DecimalField(_('Min Tick'), max_digits=12, decimal_places=2,
                                  help_text=_('Min Tick'))

    orderTypes = models.CharField(_('OrderTypes'), max_length=100,
                                  help_text=_('OrderTypes'))

    validExchanges = models.CharField(_('ValidExchanges'), max_length=100,
    ...
    longName = models.CharField(_('Long Name'), max_length=100,
                                help_text=_('Long Name'))

    contractMonth = models.CharField(_('ContractMonth'), max_length=100,
    ...
    subcategory = models.CharField(_('subcategory'), max_length=100,
                                   help_text=_('subcategory'))

    timeZoneId = models.CharField(_('timeZoneId'), max_length=100,
                                  help_text=_('timeZoneId'))

    tradingHours = models.CharField(_('timeZoneId'), max_length=100,
                                    help_text=_('timeZoneId'))

    liquidHours = models.CharField(_('liquidHours'), max_length=100,
                                   help_text=_('liquidHours'))

    evRule = models.CharField(_('evRule'), max_length=100,
                              help_text=_('evRule'))

    evMultiplier = models.CharField(_('evMultiplier'), max_length=100,
                                    help_text=_('evMultiplier'))

    mdSizeMultiplier = models.CharField(_('mdSizeevMultiplier'), max_length=100,
                                        help_text=_('mdSizeevMultiplier'))

    aggGroup = models.IntegerField(_(''), null=True, blank=True,
                                   help_text=_(''))

    underSymbol = models.CharField(_('underSymbol'), max_length=100,
                                   help_text=_('underSymbol'))

    underSecType = models.CharField(_('underSecType'), max_length=100,
                                    help_text=_('underSecType'))

    marketRulesId = models.CharField(_('marketRulesId'), max_length=100,
                                     help_text=_('marketRulesId'))

    secIdList = models.CharField(_('marketRulesId'), max_length=100,
                                 help_text=_('marketRulesId'))

    realExpirationDate = models.CharField(_('realExpirationDate'), max_length=100,
                                          help_text=_('realExpirationDate'))

    lastTradeTime = models.CharField(_('lastTradeTime'), max_length=100,
                                     help_text=_('lastTradeTime'))

    stockType = models.CharField(_('stockType'), max_length=100,
    ...
    cusip = models.CharField(_('cusip'), max_length=100,
                             help_text=_('cusip'))

    ratings = models.CharField(_('ratings'), max_length=100,
                               help_text=_('ratings'))

    descAppend = models.CharField(_('descAppend'), max_length=100,
                                  help_text=_('descAppend'))

    bondType = models.CharField(_('bondType'), max_length=100,
                                help_text=_('bondType'))

    cuponType = models.CharField(_('cuponType'), max_length=100,
    ...
    maturity = models.CharField(_('maturity'), max_length=100,
                                help_text=_('maturity'))

    issueDate = models.CharField(_('issueDate'), max_length=100,
                                 help_text=_('issueDate'))

    nextOptionDate = models.CharField(_('nextOptionDate'), max_length=100,
                                      help_text=_('nextOptionDate'))

    nextOptionType = models.CharField(_('nextOptionType'), max_length=100,
